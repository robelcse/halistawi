<div class="page-main-header">
    <div class="main-header-right row m-0">
      <div class="main-header-left">
        ...
        <div class="logo-wrapper"><a href="{{ route('dashboard') }}"><img class="img-fluid" src="{{ asset('assets/images/logo/logo_logistable.png') }}" alt=""></a></div>
        ...
        <ul class="nav-menus">
          ...
          <li class="onhover-dropdown p-0">
            ...
            <form method="POST" action="{{ route('logout') }}">
              @csrf
              <button class="btn btn-primary-light" type="button"><a href="" onclick="event.preventDefault();
